class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:subscription_type, :subscription_start_date, :subscription_end_date, :subscribed, :city, :state, :country, :street, :zip_code, :latitude, :longitude, :subscription_id)
  end
end
